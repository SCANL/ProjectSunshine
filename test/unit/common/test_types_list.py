...
class TestTypesList:
    ...
    def test_get_primitive_types_java(self):
        ...
        # Assert
        assert primitive_types == ['byte', 'short', 'int',
    ...
    def test_get_primitive_types_csharp(self):
        ...
        # Assert
        assert primitive_types == ['bool', 'byte', 'sbyte', 'char', 'decimal', 'double', 'float',
                                   'int', 'uint', 'long', 'ulong', 'short', 'ushort', 'object', 'string', 'dynamic']
    ...
    def test_get_numeric_types_java(self):
        ...
        # Assert
        assert numeric_types == ['byte', 'short', 'int', 'long', 'float',
    ...
    def test_get_numeric_types_csharp(self):
        ...
        # Assert
        assert numeric_types == ['byte', 'sbyte',  'decimal', 'double',
